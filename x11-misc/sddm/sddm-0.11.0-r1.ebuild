...
pkg_postinst() {
	...
	ewarn "If you using NVIDIA Optimus technology, add this manually into"
	ewarn "/usr/share/sddm/scripts/Xsetup"
	ewarn "xrandr --setprovideroutputsource modesetting NVIDIA-0"
	ewarn "xrandr --auto"
}
